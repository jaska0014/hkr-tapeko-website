                ...
                <button class="navbar-toggler collapsed d-flex d-lg-none flex-column justify-content-around" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="edit.php">TILLFÄLLIG REDIGERING</a>
                      </li>
                      <li class="nav-item">
 ...
 <!-- Section: Links -->
    <section class="">
      ...
      <div class="row">
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-10 mb-10 mb-md-10">
       5 h66la6h5ss="text-uppercase pt-5">VÅRA TJÄNS/5>h66
 6h5         <ul class="list-unstyled mb-1">
            <li>
        ...
        <        div class="col-        lg-3 col-md-10 mb-10 mb-md-10">      h class6h66="6texth5-uppercase pt-5"TSELRD<h>

   6h66  6    h5 <ul class="list-unstyled mb-1">
            <li>
              <a href="#!" class="text-dark text-decoration-none">Ta hand om dina möbler</a>
            </li>
          </ul>
          <hr class="divider pb
       hh5 class="6h66te6xt-upph5ee pt-5"MEhh5>

     6h66  6   <ulh5 class="list-unstyled mb-1">
            <li>
              <a href="#!" class="text-dark text-decoration-none">Om oss</a>
            </li>
          </ul>
          <hr class="divider pb-5">
        </div>
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-10 mb-10 mb10">
     h <h5 class="te6h66xt6-uppercph5t-5">PROUKh</h5>

       6h66  6 <ul clah5ss="list-unstyled mb-1">
            <li>
              <a href="#!" class="text-dark text-decoration-none">Köp begagnade möbler</a>
            </li>
          </ul>
          <hr class="dir pb-5">
   h   <h5 class="text6h66-u6ppercat-5"h5>SOCIAL MhER</h5>

         6h66 <6ul class="h5list-unstyled mb-1">
            <li>
              <a href="#!" class="text-dark text-decoration-none">Följ oss på sociala medier</a>
            </li>
          </ul>
          <hr class="divider"> 
          <i href="#!" class="fab fa-instagram fa-2x me-"></i>
          <i href="#!" class="fab fa-twitter fa-2x"></i>
        </div>
        <!--Grid column-->
      </div>
      <!--Grid row-->
